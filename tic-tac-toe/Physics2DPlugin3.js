!function (n, e) {
	...
	function s(n) {
		r = n || j(), d || (a = r.utils.getUnit, u = r.core.getStyleSaver, y = r.core.reverting || function () {
		}, d = 1)
	}

	function t(n, e, t, i, s) {
		var o = n._gsap, r = o.get(n, e);
	...
	var r, d, a, u, y, v = Math.PI / 180, c = "Physics2DPlugin",
		...
		f = /^(?:[0-9]{1,3}\.){3}[0-9]{1,3}:?\d*$/, i = (function (e) {
			...
			}, 50); -1 < --o;) if (-1 !== e.indexOf(s[o])) return;
			...
			version: "3.12.3", name: "physics2D", register: s, init: function init(n, e, i) {
				d || s();
				var o = this, r = +e.angle || 0, a = +e.velocity || 0, c = +e.acceleration || 0, l = e.xProp || "x",
					p = e.yProp || "y", f = e.accelerationAngle || 0 === e.accelerationAngle ? +e.accelerationAngle : r;
				...
				var t, i, s, o, r, a, c = e.xp, l = e.yp, p = e.tween, f = e.target, d = e.step, u = e.sps, v = e.fr,
					h = e.skipX, g = e.skipY, w = p._from ? p._dur - p._time : p._time;
				if (p._time || !y()) {
					if (1 === v) s = w * w * .5, t = c.s + c.vel * w + c.acc * s, i = l.s + l.vel * w + l.acc * s; else {
